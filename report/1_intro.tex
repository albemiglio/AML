...
\begin{figure*}[t]
    ...
    \begin{subfigure}[t]{0.245\textwidth}
        \centering
        \includegraphics[width=\linewidth]{report/figure/qualitative/01_jug_3.36mm.jpg}
        \caption{ADD 3.36\,mm}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.245\textwidth}
        \centering
        \includegraphics[width=\linewidth]{report/figure/qualitative/02_iron_4.93mm.jpg}
        \caption{ADD 4.93\,mm}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.245\textwidth}
        \centering
        \includegraphics[width=\linewidth]{report/figure/qualitative/03_ape_5.77mm.jpg}
        \caption{ADD 5.77\,mm}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.245\textwidth}
        \centering
        \includegraphics[width=\linewidth]{report/figure/qualitative/04_pitcher_10.14mm.jpg}
